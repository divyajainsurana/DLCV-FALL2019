...
torch.save(train_features, os.path.join(save_path,mode+'_rnnfeatures.pt'))
train_features = torch.load(os.path.join(save_path,mode+'_rnnfeatures.pt'))
print(mode+"_features:",len(train_features))

if mode != "test":
    test_labels = torch.LongTensor(test_labels)
    torch.save(test_labels, os.path.join(save_path,mode+'_rnnlabel.pt'))
    test_labels = torch.load(os.path.join(save_path,mode+'_rnnlabel.pt'))
