...
#parser.add_argument('-cfg', '--config', type=str, help='The path of the config.py file.', default='models/GAN/config.py')
parser.add_argument('-save_model', '--save_model', type=str, help='The path to save trained models.',default = 'save_model/GAN/')
...
# load the trainset
trainset = dset.ImageFolder(root='hw3_data/face/',# csv_dir='hw3_data/face/train.csv', 
...
print('# images in trainset:', len(trainset)) # Should print 40000
...
plt.savefig(os.path.join(args.save_img, 'training_images.jpg'))
...
plt.ylabel("Loss")
plt.legend()
plt.savefig(os.path.join(args.save_img, 'loss.jpg'))
...
plt.savefig(os.path.join(args.save_img, 'real_images.jpg'))
# Plot the fake images from the last epoch
plt.figure(figsize=(8,8))
plt.axis("off")
plt.title("Fake Images")
plt.imshow(np.transpose(img_list[-1],(1,2,0)))
plt.savefig(os.path.join(args.save_img, 'fake_images.jpg'))
